...
export default class StatusConfig extends React.Component {
  ...
  getdefectStatus() {
    const url = 'http://localhost:8083/productservice/defectstatuses';
    axios.get(url)
  ...
  getCountDefectStatus() {
    const url = 'http://localhost:8083/productservice/defectstatus';
    axios.get(url)
      .then(response => this.setState({
  ...
  editStatus = (id) => {
    ...
    axios.get('http://localhost:8083/productservice/defectstatus/' + id)
  ...
  deleteDefect = id => {
    ...
    fetch(`http://localhost:8083/productservice/defectstatus/` + id, {
  ...
  handleOk = e => {
    ...
    if (this.state.name === "" || this.state.value === "" || (!NameRegex.test(this.state.name) || !NameRegex.test(this.state.value))) {
      ...
      axios.post('http://localhost:8083/productservice/defectstatus/', obj).then((response) => {
  ...
  handleEditOk = (id) => {
    ...
    if (this.state.name === "" || this.state.value === "" || (!NameRegex.test(this.state.name) || !NameRegex.test(this.state.value))) {
      ...
      axios.put(`http://localhost:8083/productservice/defectstatus/`+id, obj).then((response) => {
        //  console.log(response);
        this.setState({ events: response.data })
        if (response.status === 200) {
