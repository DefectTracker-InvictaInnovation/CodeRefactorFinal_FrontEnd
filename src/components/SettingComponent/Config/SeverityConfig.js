...
export default class SeverityConfig extends React.Component {
  ...
  getDefectSeverity() {
    const url = 'http://localhost:8083/productservice/Severitys';
    axios.get(url)
  ...
  deleteDefectSeverity(id) {
    console.log(id)
    fetch(`http://localhost:8083/productservice/Severity/` + id, {
      method: "DELETE",
      headers: {
  ...
  handleOk = e => {
    ...
    axios.post('http://localhost:8083/productservice/Severity/', obj)
  ...
  editDefectSeverity = (id) => {
    ...
    this.setState({ id: id })
    console.log(id);
    axios.get('http://localhost:8083/productservice/Severity/' + id)
      .then(response => {
  ...
  handleEditOk = (id) => {
    ...
    axios.put("http://localhost:8083/productservice/Severity/"+id, obj)
      .then(res => this.getDefectSeverity());
    this.setState({
      name: '',
      value: '',
